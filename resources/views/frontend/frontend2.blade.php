...
<body>
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_right">
                                    ...
                                    <div class="variants_selects">
                                        ...
                                        <div class="modal_add_to_cart">
                                            <form action="">
                                                <input min="1" max="100" v-model="cart_option.qty" step="1"
                                                    type="number">
    ...
    <div class="modal fade" v-if="Object.keys(get_selected_product_for_cart).length > 0" id="cart_product_modal"
        tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-12">
                                <div class="modal_right">
                                    <div class="modal_title mb-10">
                                        <h2>@{{get_selected_product_for_cart.product.product_name}}</h2>
                                    </div>
                                    <div class="modal_price mb-10">
                                        {{-- <input type="hidden" v-model="cart_option.price"
                                        :value="get_selected_product_for_cart.default_price"> --}}
