                        ...
                        <div class="card-body">
                            ...
                            <div class="card-header">
                                <form action="#" id="campeign_form" @submit.prevent="update_campeing"  name="campeign_form">
                                                        ...
                                                        <table class="table table-hover text-center">
                                                            ...
                                                            <tfoot v-if="camp_selected_products.length">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-right">
                                                                        {{-- <input type="number" @keyup="change_total_discount" min="0" max="100" v-model="total_discount" class="form-control custom_number_input text-right" style="width: 75px;display: inline-block;"> % --}}
                                                                        @{{ total_discount }} %
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                    ...
                                    <div class="form-group">
                                        <label for="note">Additional Feilds</label>
                                        <table class="table table-hover">
                                            <tr v-for="(field,index) in additional_fields">
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="text" v-model="field.field_value" class="form-control">
                                                </td>
                                                <td style="width: 10px">
                                                    <i v-if="additional_fields.length > 1" @click="remove_additional_field(index)" style="margin-top: 25px;" class="fa fa-trash-o btn btn-sm btn-danger"></i>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4" class="text-center">
                                                    <button type="button" class="btn btn-sm btn-warning" @click="create_additional_field"><i  class="fa fa-plus "></i> create</button>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
