                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group" style="display: flex;
                                        ...
                                        <input type="text" name="display_name" v-model="display_name"
                                            class="form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="unique_name" v-model="variant_option_name"
                                            class="form-control variant_option_name">
                                        <span v-if="unique_name_check == 1"
                                            class="d-block variant_option_name_alert text-danger">name should be
                                            unique</span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        <div class="product_option_rows">
                                            <input type="text" name="item.name[]" v-model="item.name"
                                                class="custom_form_control option_name align-self-start">
                                            <div class="right_part" v-if="type=='swatch'">
                                                <select name="color_limit" v-model="item.color_limit"
                                                    class="select_colors">
                                        ...
                                        <i @click.prevent="remove_option(index)"
                                            class="fa fa-trash-o btn btn-outline-danger ml-3"></i>
                                    </div>
                                    <hr>
                                </li>
                            </ul>
