                        ...
                        <div class="card-body">
                            ...
                            <form class="insert_form product_insert_form row" method="POST" action="#" enctype="multipart/form-data">
                                ...
                                <div class="form-group col-md-6 col-xl-4">
                                    ...
                                    <input type="text" class="form-control" placeholder="THX-1138">
                                </div>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <textarea name="" class="form-control" id="mytextarea1"></textarea>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Imperial-luxury-tax-01">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" v-if="show_advance_pricing">
                                                ...
                                                <div class="col-12">
                                                    <table class="table table-bordered" style="border: 0">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(tier,index) in tiers" :key="index">
                                                                <td class="text-right">
                                                                    <input type="text" class="text-right form-control" v-model="tier.min_qty">
                                                                </td>
                                                                <td class="text-right">
                                                    ...
                                                    <a href="#" class="btn btn-outline-secondary mt-1" @click.prevent="add_tier"><i class="fa fa-plus"></i> Add tier</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="e.g.wiget, affordable, portable, etc..">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Usually ships in 24 hours."/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row pl-5 mb-5" v-if="purchasability == 'comming_soon'">
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="Expected release date is %%DATE%%">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date"  class="form-control" placeholder="D MMM YYYY">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3" style="align-self: center;margin-top: 24px;">
                                                            <div class="d-flex align-items-center mb-3">
                                                                <input  name="" type="checkbox" class="form-control d-inline-block mr-2" style="width: 42px;">
                                                    ...
                                                    <div class="row pl-5 mb-5" v-if="purchasability == 'can_not_be_purchased_in_online_store'">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="d-flex align-items-center mb-3">
                                                                    <input  name="" type="checkbox" class="form-control d-inline-block mr-2" style="width: 26px;">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" value="Contact us at 555-5555">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <div class="col-12 d-flex align-items-center mb-3">
                                                            <input id="custom_information" name="custom_information" type="checkbox" class="form-control d-inline-block mr-2" style="width: 25px;">
                                                    ...
                                                    <div class="card-body">
                                                        <div v-for="(hs_code,index) in hs_codes" :key="hs_code.country+Math.random()"
                                                            ...
                                                            <div class="ml-3" style="width: 47%">
                                                                ...
                                                                <input type="text" class="form-control" v-model="hs_code.code">
                                                            </div>
                                                            <div style="align-self: flex-end;margin-bottom: 10px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" style="width: 83%; display: inline-block;">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <input id="use_title" name="custom_information" type="checkbox" class="form-control d-inline-block mr-2" style="width: 25px;">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <input id="use_description" name="custom_information" type="checkbox" class="form-control d-inline-block mr-2" style="width: 25px;">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <input id="use_thumbnail_1" name="use_thumbnail_image" checked type="radio" class="form-control d-inline-block mr-2" style="width: 25px;">
                                                        <label for="use_thumbnail_1" style="line-height: 30px; margin: 0px;">Use thumbnail image</label>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="d-flex align-items-center mb-3">
                                                        <input id="use_thumbnail_2" name="use_thumbnail_image" type="radio" class="form-control d-inline-block mr-2" style="width: 25px;">
