                        ...
                        <form id="form_body" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Product URL
                                            Settings</label>
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="product_url_settings"
                                                    v-model="form_data.product_url_settings" type="radio" value="1">
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized (Short)https://demo.mybigcommerce.com/ipod-nano/</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="product_url_settings"
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized
                                                    (Long)https://demo.mybigcommerce.com/products/ipod-nano.html</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="product_url_settings"
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized (Category)
                                                    Hinthttps://demo.mybigcommerce.com/mp3-players/ipod-nano/</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <div class="row">
                                                    <div class="col-1">
                                                        <input class="form-check-input"
                                                            v-model="form_data.product_url_settings" type="radio" value="4">
                                                        <label class="form-check-label"
                                                            for="flexSwitchCheckDefault">Custom</label>
                                                    </div>
                                                    <div class="col-6">

                                                        <input class="form-control" name="product_url_custom_settings"
                                                            v-model="form_data.product_url_custom_settings" type="text">
                                                    </div>
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Category URL
                                            Format</label>
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized (Short)https://demo.mybigcommerce.com/apple-ipod/</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="category_url_format"
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized
                                                    (Long)https://demo.mybigcommerce.com/categories/apple-ipod.html</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <div class="row">
                                                    <div class="col-1">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Web Page URL
                                            Format</label>
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized (Short)https://demo.mybigcommerce.com/about-us/</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" name="web_page_url_format"
                                                ...
                                                <label class="form-check-label" for="flexSwitchCheckDefault">SEO
                                                    Optimized
                                                    (Long)https://demo.mybigcommerce.com/pages/about-us.html</label>
                                            </div>
                                            <div class="form-check form-switch">
                                                <div class="row">
                                                    <div class="col-1">
