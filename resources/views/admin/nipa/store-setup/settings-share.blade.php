                ...
                <div class="row" id="store_setup_settings_share">
                    <div class="col-xl-11 mx-auto">
                        <form id="form_body" method="POST" enctype="multipart/form-data">
                            ...
                            <hr />
                            <p>Share controls are displayed on product pages and blog posts.</p>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch" v-if="form_data.facebook == 1">
                                                <input class="form-check-input" name="facebook"
                                                    v-model="form_data.facebook" type="checkbox">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch" v-if="form_data.twitter == 1">
                                                <input class="form-check-input" name="twitter"
                                                    v-model="form_data.twitter" type="checkbox">
                                                <label class="form-check-label" for="flexSwitchCheckDefault">Yes</label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2"
                                            class="col-sm-3 col-form-label">Instagram</label>
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch" v-if="form_data.instagram == 1">
                                                <input class="form-check-input" name="instagram"
                                                    v-model="form_data.instagram" type="checkbox">
                                                <label class="form-check-label" for="flexSwitchCheckDefault">Yes</label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch" v-if="form_data.linkedin == 1">
                                                <input class="form-check-input" name="linkedin"
                                                    v-model="form_data.linkedin" type="checkbox">
                                                <label class="form-check-label" for="flexSwitchCheckDefault">Yes</label>
                                            </div>
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2"
                                            class="col-sm-3 col-form-label">Pinterest</label>
                                        <div class="col-sm-9">
                                            <div class="form-check form-switch" v-if="form_data.pinterest == 1">
                                                <input class="form-check-input" name="pinterest"
                                                    v-model="form_data.pinterest" type="checkbox">
                                                <label class="form-check-label" for="flexSwitchCheckDefault">Yes</label>
                                            </div>
