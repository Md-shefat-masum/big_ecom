        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Update Product Object Type</div>
                        ...
                        <form id="form_body" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmailAddress2" class="col-sm-3 col-form-label">Object Type
                                            Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" v-model="form_data.object_type_name" name="object_type_name"
                                                class="form-control">
                                        </div>
                                    </div>
