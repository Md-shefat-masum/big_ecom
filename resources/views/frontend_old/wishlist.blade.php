...
<!--wishlist area start -->
<div class="wishlist_page_bg" id="wish-list">
    <div class="container">
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="product_remove"><a href="#">X</a></td>
                                                <td class="product_thumb"><a href="#"><img
                                                            src="{{ asset('contents/frontend') }}/assets/img/s-product/product2.jpg"
                                                            alt=""></a></td>
                                            ...
                                            <tr>
                                                <td class="product_remove"><a href="#">X</a></td>
                                                <td class="product_thumb"><a href="#"><img
                                                            src="{{ asset('contents/frontend') }}/assets/img/s-product/product3.jpg"
                                                            alt=""></a></td>
