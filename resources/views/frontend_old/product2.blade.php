        ...
        <div class="row">
                ...
                <aside class="sidebar_widget">
                    <div class="widget_list widget_categories">
                        ...
                        <ul>
                            ...
                            <li v-if="limit <= 9"><a @click.prevent="getCatLimit"><i class="fa fa-plus"
                                        aria-hidden="true"></i> More Categories</a></li>
                            <li v-if="limit >= 10"><a @click.prevent="getCatLimit"><i class="fa fa-plus"
                                        aria-hidden="true"></i> Less Categories</a></li>
                        </ul>
                    ...
                    <a class="secondary_img" href="product-details.html"><img
                            src="{{ asset('contents/frontend') }}/assets/img/product/product10.jpg" alt=""></a>
            </div>
            ...
            <article class="recent_product_list">
                <figure>
                    <div class="product_thumb">
                        <a class="primary_img" href="product-details.html"><img
                                src="{{ asset('contents/frontend') }}/assets/img/product/product11.jpg" alt=""></a>
                        <a class="secondary_img" href="product-details.html"><img
                                src="{{ asset('contents/frontend') }}/assets/img/product/product12.jpg" alt=""></a>
                    </div>
                    <div class="product_content">
            ...
            <article class="recent_product_list">
                <figure>
                    <div class="product_thumb">
                        ...
                        <a class="secondary_img" href="product-details.html"><img
                                src="{{ asset('contents/frontend') }}/assets/img/product/product13.jpg" alt=""></a>
                    </div>
                    <div class="product_content">
        ...
        <div class="col-lg-3 col-md-4 col-12 " v-for="item in product_list.data" :key="item.id">
                ...
                <article class="single_product">
                    <figure>
                        <div class="product_thumb">
                            {{-- <a href="">@{{image.id}}</a> --}}
                            {{-- v-for="image in image_list.data" :key="image.id" --}}
                            ...
                            <a class="secondary_img" href="product-details.html" v-if="item.related_image[1]"><img
                                   :src="`/${item.related_image[1].image}`" alt=""></a>
                        ...
                        <div class="product_content list_content">
                            ...
                            <div class="add_to_cart">
                                <a href="#" @click.prevent="add_selected_product_for_cart(item)" title="Add to cart">Add
                                    to cart</a>
                            </div>
                            <div class="action_links">
                                <ul>
