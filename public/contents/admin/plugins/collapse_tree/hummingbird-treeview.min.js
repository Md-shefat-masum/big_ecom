        ...
        $.each(all_converter, function (e) {
            ...
            $.each(tree, function (i, e) {
                ...
                if (numHyphen < numHyphen_next) {
                    ...
                    item = item + '<i class="fa fa-plus-circle"></i>' + "\n";
    ...
    $.fn.hummingbird = function (options) {
        ...
        if (typeof methodName == "undefined") {
            return this.each(function () {
                ...
                if (options.collapsedSymbol != "fa-plus-circle") {
                    $(this).find("i").removeClass("fa-plus-circle").addClass(options.collapsedSymbol)
                }
        ...
        if (methodName == "addNode") {
            return this.each(function () {
                var pos = args[1].pos;
                var anchor_sel = args[1].anchor_sel;
                var anchor_vals = args[1].anchor_vals;
    ...
    $.fn.hummingbird.disableNode = function (tree, sel, vals, state, disableChildren) {
        $.each(vals, function (i, e) {
            ...
            if (disableChildren === true) {
                this_checkbox.parent("label").parent("li").find("input:checkbox").prop("disabled", true).prop("checked", state).parent("label").css({
                    color: "#c8c8c8",
                    cursor: "not-allowed",
                    "background-color": ""
                })
            } else {
                this_checkbox.prop("checked", state).prop("disabled", true).parent("label").css({
                    color: "#c8c8c8",
                    cursor: "not-allowed",
                    "background-color": ""
                })
    ...
    $.fn.hummingbird.enableNode = function (tree, sel, vals, state, enableChildren) {
        $.each(vals, function (i, e) {
            ...
            if (enableChildren === true) {
                this_checkbox.parent("label").parent("li").find("input:checkbox").prop("disabled", false).prop("checked", state).parent("label").css({
                    color: textcolor,
                    cursor: "pointer"
                })
            } else {
                this_checkbox.prop("checked", state).prop("disabled", false).parent("label").css({
                    color: textcolor,
                    cursor: "pointer"
                })
            }
        ...
        $.each(the_uls, function (i, e) {
            ...
            if (disabled_num_the_checkboxes == num_the_checkboxes) {
                if (checkboxesGroups == false) {
                    $(this).parent("li").children("label").children("input:checkbox").prop("disabled", true).css({
                        cursor: "not-allowed"
                    }).parent("label").css({
                        color: "#c8c8c8",
                        cursor: "not-allowed",
                ...
                if (checkboxesGroups == false) {
                    $(this).parent("li").children("label").children("input:checkbox").prop("disabled", false).css({
                        cursor: "pointer"
                    }).parent("label").css({
                        color: textcolor,
                        cursor: "pointer",
            ...
            $(dialog + " #" + search_output + " li").on("click", function (e) {
                ...
                if (first_search == false) {
                    if (this_var_checkbox.prop("disabled")) {
                        this_var_checkbox.parent("label").css({
                            color: "#c8c8c8",
                            cursor: "not-allowed"
                        })
                    } else {
